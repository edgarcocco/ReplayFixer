...
namespace Wpf.Ui.Demo.Services
{
    ...
    public class ApplicationHostService : IHostedService
    {
        ...
        public ApplicationHostService(IServiceProvider serviceProvider, INavigationService navigationService,
            IPageService pageService, IThemeService themeService, ILogger<ApplicationHostService> logger)
        {
        ...
        private async Task HandleActivationAsync()
        {
            ...
            if (!Application.Current.Windows.OfType<Container>().Any())
            {
                ...
                if(_navigationWindow == null) throw new Exception("Couldn't find a Navigation Window service.");
            ...
            } else { _logger.LogWarning("Couldn't find a notify icon manager service, this will be disabled."); }

            _logger.LogInformation("Main Window created and initialized.");
